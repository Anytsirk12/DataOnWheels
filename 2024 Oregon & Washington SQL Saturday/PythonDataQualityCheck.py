...
#print(f"CREDS: {sqlserver,sqldb,sqluser,sqlpassword,pbiclientid,pbidatasetid}")
...
try:
    sql_con = pymssql.connect(server=sqlserver,user=sqluser,password=sqlpassword,database=sqldb)
